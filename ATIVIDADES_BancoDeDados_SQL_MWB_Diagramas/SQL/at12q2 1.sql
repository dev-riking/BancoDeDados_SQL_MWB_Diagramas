...
desc Gravacao;
desc Cantor;
alter table Compositor add Estilo_Musical varchar(50);
alter table Musica add Duracao time;
alter table Musica add Data_Lancamento date after Titulo;
alter table Musica drop column Letra;
alter table Gravacao change Gravacao Local_Gravacao varchar(45);
alter table Gravacao add Data_Gravacao date after Local_Gravacao;
alter table Cantor add Genero_Musical varchar(50);
alter table Cantor add Numero_Albums int(3);
alter table Cantor add nome_artistico varchar(45)after nome;
